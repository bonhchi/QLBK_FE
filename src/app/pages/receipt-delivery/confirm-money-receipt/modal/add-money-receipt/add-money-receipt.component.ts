...
@Component({
  selector: 'app-add-money-receipt',
  templateUrl: './add-money-receipt.component.html',
  styleUrls: ['./add-money-receipt.component.scss']
})
export class AddMoneyReceiptComponent implements OnInit {
  ...
  private _formControl() {
    this.form = this._formBuilder.group({
      ...
      receipt_receive_user: [{ value: '', disabled: false }],
      receipt_receive_role: [{ value: 'QUỸ PHỤ', disabled: false }],
