...
export class PriceDetailComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PriceDetailComponent>,
  ...
  _formControl() {
    this.form = this.formBuilder.group({
      ccy: [{ value: this.data.ccy, disabled: true }, Validators.required],
      denominations: [{ value: this.data.denominations, disabled: false }, Validators.required],
    });
  }
